...
/**
 * Catalogue workflows Acquisition — recettes opérationnelles (pas seulement 2 démos).
    ...
    actions: [
      {
        ...
        config: {
          body:
            'Merci pour ton commentaire 💛 FitMangas, ce n’est pas une vidéo de plus : un rendez-vous fixe en visio, Alejandra te corrige en direct. Voici ton essai 7 jours :',
        },
      },
    ...
    actions: [
      {
        ...
        config: {
          body:
            'Tu as raison de demander 💛 Ce n’est pas du Pilates YouTube : c’est un créneau fixe, la correction en direct, et le fait d’être vue. L’essai 7 jours te laisse juger sans pression :',
        },
      },
      { type: 'send_trial_link' },
    ...
    actions: [
      {
        ...
        config: {
          body:
            'Justement : le produit n’est pas « trouver 1h toute seule ». C’est un rendez-vous déjà posé dans la semaine — tu viens, Alejandra te voit, tu n’as pas à t’auto-motiver. Essai 7 jours pour tester le créneau :',
        },
      },
      { type: 'send_trial_link' },
    ...
    actions: [
      {
        ...
        config: {
          body:
            'Tu n’as pas besoin d’être souple pour commencer — la plupart des Mangitas arrivent exactement comme toi. En visio, Alejandra adapte et corrige en direct. Tu veux tester 7 jours ?',
        },
      },
      { type: 'send_trial_link' },
    ...
    actions: [
      {
        ...
        config: {
          body:
            'Merci pour ta réponse à la story 💛 FitMangas = rendez-vous fixe + correction en direct (pas du solo YouTube). Tu veux tester 7 jours ?',
        },
      },
      { type: 'send_trial_link' },
    ...
    actions: [
      {
        ...
        config: {
          body:
            'Bonjour 💛 Content(e) de te lire. FitMangas, ce n’est pas une vidéo de plus : un rendez-vous fixe en visio, Alejandra te corrige en direct — tu n’es pas seule. Tu veux l’essai 7 jours ?',
        },
      },
      { type: 'send_trial_link' },
    ...
    actions: [
      {
        ...
        config: {
          body:
            'Merci pour ton message 💛 Beaucoup de Mangitas sont passées par là. En visio, Alejandra adapte et te corrige en direct — tu n’es pas seule à gérer ça. Voici l’essai 7 jours :',
        },
      },
      { type: 'send_trial_link' },
    ...
    actions: [
      {
        ...
        config: {
          body:
            'Un tapis suffit pour commencer 💛 Pas besoin d’un studio à la maison. L’important, c’est le rendez-vous fixe et la correction en direct. Tu veux tester 7 jours ?',
        },
      },
      { type: 'send_trial_link' },
    ...
    actions: [
      {
        ...
        config: {
          body:
            'Je t’envoie ça en privé 💛 FitMangas = rendez-vous fixe + correction en direct. Essai 7 jours ici :',
        },
      },
      { type: 'send_trial_link' },
    ...
    actions: [
      {
        ...
        config: {
          body:
            'Tu n’es pas obligée d’être « à l’aise » dès le jour 1 💛 En visio, Alejandra te voit pour te corriger — pas pour te juger. Beaucoup de Mangitas ont démarré exactement comme toi. Essai 7 jours :',
        },
      },
      { type: 'send_trial_link' },
