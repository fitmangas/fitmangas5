...
export const WORKFLOW_CATALOG: AcqWorkflow[] = [
    ...
    actions: [
      {
        ...
        config: bilingualSend(
          lines(
            ...
            'Tu as des cours collectifs en visio à horaires fixes,',
          ...
          lines(
            ...
            'Tienes clases grupales en visio con horarios fijos,',
    ...
    actions: [
      {
        ...
        config: bilingualSend(
          lines(
            ...
            'Je te pose un créneau de cours en groupe dans la semaine :',
          ...
          lines(
            ...
            'Te pongo un horario de clase grupal en la semana:',
    ...
    actions: [
      {
        ...
        config: bilingualSend(
          lines(
            ...
            '',
            'La plupart de mes élèves arrivent exactement comme toi.',
          ...
          lines(
            ...
            '',
            'La mayoría de mis alumnas llegan exactamente como tú.',
    ...
    actions: [
      {
        ...
        config: bilingualSend(
          ...
          lines(
            ...
            'clases grupales con horarios fijos, te corrijo en directo, te veo.',
            '',
            'Prueba 7 días gratis ✨',
            '',
    ...
    actions: [
      {
        ...
        config: bilingualSend(
          lines(
            ...
            '',
            'Avec moi en visio :',
            '• des cours collectifs à horaires fixes',
          ...
          lines(
            ...
            '',
            'Conmigo en visio:',
            '• clases grupales con horarios fijos',
    ...
    actions: [
      {
        ...
        config: bilingualSend(
          lines(
            ...
            '',
            'Beaucoup de mes élèves sont passées par là.',
            'En visio, j’adapte et je te corrige en direct —',
          ...
          lines(
            ...
            '',
            'Muchas de mis alumnas han pasado por eso.',
            'En visio, adapto y te corrijo en directo —',
    ...
    actions: [
      {
        ...
        config: bilingualSend(
          lines(
            ...
            'Ce qui compte : le créneau de cours avec moi + ma correction en direct.',
            '',
            'Essai 7 jours gratuits ✨',
            '',
            'Clique ici →',
          ...
          lines(
            ...
            'Lo que cuenta: la clase conmigo + mi corrección en directo.',
            '',
            'Prueba 7 días gratis ✨',
            '',
            'Haz clic aquí →',
    ...
    actions: [
      {
        ...
        config: bilingualSend(
          lines(
            ...
            '',
            'Avec moi : cours collectifs à horaires fixes + correction en direct.',
          ...
          lines(
            ...
            '',
            'Conmigo: clases grupales con horarios fijos + corrección en directo.',
    ...
    actions: [
      {
        ...
        config: bilingualSend(
          lines(
            ...
            'Beaucoup de mes élèves ont démarré exactement comme toi.',
            '',
            'Essai 7 jours gratuits ✨',
            '',
            'Viens tester avec moi →',
          ...
          lines(
            ...
            'Muchas de mis alumnas empezaron exactamente como tú.',
            '',
            'Prueba 7 días gratis ✨',
            '',
            'Ven a probar conmigo →',
  ...
  },
  {
    ...
    name: 'Messenger « prix / info » → tarif groupe 39€',
    enabled: true,
    triggerType: 'messenger_inbound',
    triggerConfig: {
      keyword:
  ...
  },
  {
    ...
    name: 'WhatsApp « prix / info » → tarif groupe 39€',
    enabled: true,
    triggerType: 'whatsapp_inbound',
    triggerConfig: {
      keyword:
    ...
    actions: [
      {
        ...
        config: bilingualSend(
          lines(
            'Justement 💛',
            '',
            'Je te pose un créneau de cours en groupe : tu viens, je te vois, tu n’as plus à t’auto-motiver.',
            '',
            'Essai 7 jours gratuits ✨',
            '',
            'Teste un vrai créneau avec moi →',
    ...
    actions: [
      {
        ...
        config: bilingualSend(
          lines(
            'Justement 💛',
            '',
            'Je te pose un créneau de cours en groupe : tu viens, je te vois.',
            '',
            'Essai 7 jours gratuits ✨',
            '',
            'Clique ici →',
  ...
  },
  {
    ...
    name: 'DM bouton « Prix / info » → tarif groupe 39€',
    enabled: true,
    triggerType: 'ig_dm_inbound',
    ...
    actions: [
      {
        ...
        config: bilingualSend(
          lines(
            'Voici mes profils 💛',
            '',
            'Pas un guide « comment démarrer le Pilates ».',
            'Des tests pour comprendre comment tu tiens — ou pourquoi tu lâches.',
            '',
            'Choisis le tien → https://fitmangas.com/quiz',
          ),
          lines(
            'Aquí tienes mis perfiles 💛',
            '',
            'No es una guía « cómo empezar Pilates ».',
            'Tests para entender cómo te mantienes — o por qué sueltas.',
            '',
            'Elige el tuyo → https://fitmangas.com/es/quiz',
          ),
          true,
          QR_RESOURCE,
        ),
      },
      { type: 'tag_contact', config: { tag: 'quiz_hub' } },
      { type: 'set_lifecycle_stage', config: { stage: 'qualified' } },
    ],
  },
