  ...
  try {
    ...
    const [coursesRes, recordingsRes] = await Promise.all([
      admin
        .from('courses')
        .select(
          'id, slug, title, description, course_format, course_category, starts_at, ends_at, timezone, capacity_max, location, live_url, jitsi_link, replay_url, spotify_playlist_url, is_published, course_language, course_skill_level, created_at',
        )
