...
export default async function ComptePage({
  ...
  return (
    <div className="mx-auto max-w-5xl space-y-10 px-5 pb-16 md:space-y-12 md:px-8">
      <GlassCard className="p-8 md:p-10">
        <p className="text-[10px] font-semibold uppercase tracking-[0.32em] text-luxury-soft">Espace client</p>
        <h1 className="mt-3 text-3xl font-semibold tracking-tight text-luxury-ink md:text-[2.15rem]">Bienvenue</h1>
        {checkoutOk && (
          <p className="mt-6 rounded-2xl border border-emerald-400/25 bg-emerald-500/10 px-5 py-3.5 text-sm leading-relaxed text-emerald-900">
        ...
        <p className="mt-6 text-sm leading-relaxed text-luxury-muted">
          Connecté en tant que <span className="font-medium text-luxury-ink">{user.email}</span>
        </p>
        <div className="mt-10 grid gap-4 border-t border-white/30 pt-10 sm:grid-cols-2">
      ...
      <section className="space-y-6">
        <div className="px-1">
          <p className="text-[10px] font-semibold uppercase tracking-[0.28em] text-luxury-soft">Planning</p>
