...
export async function AdminViewSwitch() {
  ...
  return (
    <Link
      ...
      className="fixed bottom-5 right-5 z-[220] rounded-full border border-white/70 bg-white/85 px-4 py-2 text-[11px] font-bold uppercase tracking-[0.18em] text-luxury-ink shadow-[0_14px_36px_rgba(15,23,42,0.18)] backdrop-blur transition hover:-translate-y-0.5 hover:border-luxury-orange/40"
