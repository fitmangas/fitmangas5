...
const FIELD =
  'h-11 rounded-2xl border border-[#D9C9B4] bg-white px-4 text-sm text-luxury-ink shadow-[inset_0_1px_3px_rgba(31,27,22,0.08)] outline-none focus:border-[#C45D3E]/60 focus:ring-2 focus:ring-[#C45D3E]/25';
const DATE_FIELD = `${FIELD} w-full sm:w-[10rem]`;
const TIME_FIELD = `${FIELD} w-full sm:w-[10rem]`;
